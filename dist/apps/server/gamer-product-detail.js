...
/* harmony import */ var _apps_gamer_src_app_services_cart_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../apps/gamer/src/app/services/cart.service */ "iGXF");
/* harmony import */ var _apps_gamer_src_app_services_product_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../../../apps/gamer/src/app/services/product.service */ "WFtJ");
/* harmony import */ var _condition_enum__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./condition.enum */ "UWYI");
...
function ProductDetailComponent_div_1_span_8_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"]("- ", ctx_r2.item.sold_quantity, " vendidos");
} }
function ProductDetailComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](8, ProductDetailComponent_div_1_span_8_Template, 2, 1, "span", 9);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ProductDetailComponent_div_1_Template_button_click_14_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r4); const ctx_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](); return ctx_r3.addToCart(); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpropertyInterpolate"]("src", ctx_r0.item.thumbnail, _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsanitizeUrl"]);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](4);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"]("", ctx_r0.conditions[ctx_r0.item.condition], " ");
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx_r0.item.sold_quantity);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](ctx_r0.item.title);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵpipeBind1"](13, 6, ctx_r0.item.price.amount));
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](7);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtextInterpolate1"](" ", ctx_r0.item.short_description, " ");
} }
...
let ProductDetailComponent = class ProductDetailComponent {
    constructor(activatedRoute, productService, cartService) {
        ...
        this.conditions = _condition_enum__WEBPACK_IMPORTED_MODULE_6__["CONDITIONS"];
        this.error = '';
    }
    ngOnInit() {
        this.getProduct();
        this.cartService.itemsChanged.pipe(Object(_ngneat_until_destroy__WEBPACK_IMPORTED_MODULE_3__["untilDestroyed"])(this)).subscribe((item) => (this.inCart = item));
    }
    getProduct() {
...
ProductDetailComponent.ɵfac = function ProductDetailComponent_Factory(t) { return new (t || ProductDetailComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_apps_gamer_src_app_services_product_service__WEBPACK_IMPORTED_MODULE_5__["ProductService"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_apps_gamer_src_app_services_cart_service__WEBPACK_IMPORTED_MODULE_4__["CartService"])); };
ProductDetailComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ProductDetailComponent, selectors: [["gamer-product-detail"]], decls: 3, vars: 2, consts: [[1, "row", "no-gutters", "product-detail"], ["class", "col-md-10 product-detail__wrapper", 4, "ngIf"], ["class", "row p-3 error-container", 4, "ngIf"], [1, "col-md-10", "product-detail__wrapper"], [1, "row"], [1, "col-md-8", "text-center", "text-md-left"], ["alt", "product picture", 1, "product-detail__image", 3, "src"], [1, "col-md-4"], [1, "product-detail__condition"], [4, "ngIf"], [1, "product-detail__title"], [1, "product-detail__price"], ["type", "button", "id", "add", 1, "btn", "btn-primary", "product-detail__button", 3, "click"], [1, "col-md-12", "product-detail__description"], [1, "product-detail__description__content"], [1, "row", "p-3", "error-container"], ["role", "alert", 1, "col-md-10", "error-container__alert", "alert", "alert-danger"]], template: function ProductDetailComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](1, ProductDetailComponent_div_1_Template, 20, 8, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](2, ProductDetailComponent_div_2_Template, 3, 1, "div", 2);
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx.item);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", ctx.error);
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_7__["NgIf"]], pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_7__["CurrencyPipe"]], styles: [".product-detail__wrapper[_ngcontent-%COMP%] {\n  padding: 2rem;\n  margin: 0 auto;\n  background-color: white;\n  border-radius: 4px;\n}\n@media only screen and (min-width: 768px) {\n  .product-detail__wrapper[_ngcontent-%COMP%] {\n    min-height: 23rem;\n  }\n}\n.product-detail__title[_ngcontent-%COMP%] {\n  font-size: 24px;\n  font-weight: bold;\n  padding-bottom: 2rem;\n  margin-bottom: 0;\n}\n.product-detail__condition[_ngcontent-%COMP%] {\n  padding-top: 2rem;\n  font-size: 14px;\n  margin-bottom: 1rem;\n}\n.product-detail__price[_ngcontent-%COMP%] {\n  font-size: 46px;\n  padding-bottom: 2rem;\n}\n@media only screen and (min-width: 768px) {\n  .product-detail__price[_ngcontent-%COMP%] {\n    font-size: 36px;\n  }\n}\n@media only screen and (min-width: 992px) {\n  .product-detail__price[_ngcontent-%COMP%] {\n    font-size: 46px;\n  }\n}\n.product-detail__description[_ngcontent-%COMP%] {\n  bottom: 0;\n  left: 0;\n  padding: 1rem;\n}\n@media only screen and (min-width: 992px) {\n  .product-detail__description[_ngcontent-%COMP%] {\n    padding: 1.5rem;\n  }\n}\n.product-detail__description__title[_ngcontent-%COMP%] {\n  font-size: 28px;\n  padding-bottom: 2rem;\n  margin-bottom: 0;\n}\n.product-detail__description__content[_ngcontent-%COMP%] {\n  color: #999999;\n  font-size: 16px;\n  margin-bottom: 0;\n  max-height: 15rem;\n  overflow: hidden;\n}\n.product-detail__image[_ngcontent-%COMP%] {\n  max-height: 28rem;\n  max-width: 18rem;\n}\n@media only screen and (min-width: 992px) {\n  .product-detail__image[_ngcontent-%COMP%] {\n    max-width: initial;\n  }\n}\n.product-detail__button[_ngcontent-%COMP%] {\n  width: 100%;\n  margin-top: 1.6rem;\n  border: 0;\n  height: 3rem;\n  background: #b1ff00;\n  background: linear-gradient(90deg, #020024 0%, #92cadf 0%, #b1ff00 54%);\n  font-weight: bold;\n  font-size: 20px;\n}\n.product-detail__button[_ngcontent-%COMP%]:hover, .product-detail__button[_ngcontent-%COMP%]:not(:disabled):not(.disabled).active, .product-detail__button[_ngcontent-%COMP%]:not(:disabled):not(.disabled):active {\n  background: linear-gradient(90deg, black 0%, #6bb7d3 0%, #8ecc00 54%);\n}\n.error-container__alert[_ngcontent-%COMP%] {\n  padding: 2rem;\n  margin: 0 auto;\n}"] });
ProductDetailComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"],
        _apps_gamer_src_app_services_product_service__WEBPACK_IMPORTED_MODULE_5__["ProductService"],
        _apps_gamer_src_app_services_cart_service__WEBPACK_IMPORTED_MODULE_4__["CartService"]])
], ProductDetailComponent);

(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ProductDetailComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }, { type: _apps_gamer_src_app_services_product_service__WEBPACK_IMPORTED_MODULE_5__["ProductService"] }, { type: _apps_gamer_src_app_services_cart_service__WEBPACK_IMPORTED_MODULE_4__["CartService"] }]; }, null); })();
